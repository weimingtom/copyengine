package copyengine.ui.dialog.animation
{
	...
	public class MovieClipTweenDialogAnimation implements IDialogAnimation
	{
		...
		{
			GlobalTick.instance.playTweenEffect(ceDialog,ResUtils.getMovieClip("CZ_CEDialogShowAnimation","IsoHax_asset"),_callBackFunction);
		}
		
		public function closeDialog(_callBackFunction:Function):void
		{
			GlobalTick.instance.playTweenEffect(ceDialog,ResUtils.getMovieClip("CZ_CEDialogCloseAnimation","IsoHax_asset"),_callBackFunction);
		}
